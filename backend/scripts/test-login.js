...
async function testLogin() {
  try {
    ...
    if (response.data.success) {
      ...
      console.log('');
      console.log('🧪 Ejemplo de petición a la API de administrador:');
      console.log(`   curl -X GET ${BASE_URL}/admin/psicologos \\`);
      console.log('     -H "Authorization: Bearer', response.data.data.token, '"');
    } else {
