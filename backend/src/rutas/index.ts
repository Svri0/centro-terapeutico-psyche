...
import solicitudesPublicasRoutes from './solicitudes-publicas.routes';
...
// Rutas públicas de solicitudes (sin autenticación)
router.use('/publico', solicitudesPublicasRoutes);
