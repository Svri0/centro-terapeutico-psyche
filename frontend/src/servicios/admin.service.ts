...
export interface ActualizarRecepcionistaData {
  nombres?: string;
  apellidos?: string;
  email?: string;
  telefono?: string;
...
class AdminService {
  ...
  async actualizarRecepcionista(id: string, data: ActualizarRecepcionistaData, avatar?: File): Promise<Recepcionista> {
    try {
      const formData = new FormData();
