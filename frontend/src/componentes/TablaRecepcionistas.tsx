              ...
              <tr>
                <td colSpan={5} className="px-6 py-12 text-center">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-gray-500 text-lg font-medium">No se encontraron recepcionistas</p>
                    <p className="text-gray-400 text-sm mt-1">
                      {recepcionistas.length === 0 
                        ? 'No hay recepcionistas registrados en el sistema' 
                        : 'No hay recepcionistas que coincidan con los filtros aplicados'}
                    </p>
                  </div>
                </td>
              </tr>
              ...
              recepcionistasFiltrados.map((recepcionista) => (
                <tr key={recepcionista.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    {recepcionista.fecha_creacion ? new Date(recepcionista.fecha_creacion).toLocaleDateString('es-CL') : 'N/A'}
                  </td>
